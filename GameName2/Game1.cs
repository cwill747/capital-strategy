...
namespace GameName2
{
    ...
    public class Game1 : Game
    {
            ...
            : base()
        {
            ...
            graphics.PreferredBackBufferWidth = this.BOARDWIDTH;
            graphics.PreferredBackBufferHeight = this.BOARDHEIGHT;
        ...
        protected override void LoadContent()
        {
            ...
            // Game1 game, int maxHealth, int attack, int defense, int maxMove, double speed, String type, int[] imageDimensions, int[] stateDurations, Point[] attackPoints, int? attackRange, int attackDelayConst, int attackDelayRate)
            axestanShield = new WarriorType(this, 80, 50, 40, 3, 1, "axestan shield", new int[] { 1, 8, 8, 13, 7, 9, 7 }, new int[] { 1000, 700, 1000, 1000, 1000, 1000, 1000 }, 
                null, 1, 500, 0);
            firedragon = new WarriorType(this, 60, 40, 70, 4, 2, "firedragon", new int[] { 1, 7, 7, 9, 1, 11, 7 }, new int[] { 1000, 400, 1000, 1000, 1000, 1000, 1000 },
                null, 2, 500, 0);
            blueArcher = new WarriorType(this, 70, 40, 50, 4, 1, "blue archer", new int[] { 1, 8, 8, 13, 9, 13, 9 }, new int[] { 1000, 700, 1000, 1000, 1000, 1000, 1000 },
                null, 6, 500, 10);
            this.whiteMage = new WarriorType(this, 50, 80, 30, 4, 1, "white mage", new int[] { 1, 8, 8, 13, 9, 13, 9 }, new int[] { 1000, 700, 1000, 1000, 1000, 1000, 1000 }, 
                new Point[] { new Point(-1,-1), new Point(1,1), new Point(1,-1), new Point(-1,1), new Point(-2, 0), new Point(2, 0), new Point(0, 2), new Point(0, -2) }, null, 500, 0);
            crocy = new WarriorType(this, 90, 60, 50, 2, 1, "crocy", new int[] { 1, 8, 8, 11, 9, 11, 9 }, new int[] { 1000, 700, 1000, 1000, 1000, 1000, 1000 },
                null, 1, 500, 0);
            magier = new WarriorType(this, 70, 40, 45, 3, 2, "magier", new int[] { 9, 7, 7, 9, 9, 10, 9 }, new int[] { 1000, 500, 1000, 1500, 1000, 1000, 1000 },
                null, 3, 500, 10);
            for (int i = 0; i < 2; i++)
            {
